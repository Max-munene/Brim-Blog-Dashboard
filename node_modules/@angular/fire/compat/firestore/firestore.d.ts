...
export declare class AngularFirestore {
     ...
     * set.
     */
    collection<T extends firebase.firestore.DocumentData>(path: string, queryFn?: QueryFn): AngularFirestoreCollection<T>;
    collection<T extends firebase.firestore.DocumentData>(ref: CollectionReference, queryFn?: QueryFn): AngularFirestoreCollection<T>;
    /**
     * Create a reference to a Firestore Collection Group based on a collectionId
     * and an optional query function to narrow the result
     * set.
     */
    collectionGroup<T extends firebase.firestore.DocumentData>(collectionId: string, queryGroupFn?: QueryGroupFn<T>): AngularFirestoreCollectionGroup<T>;
    /**
     ...
     */
    doc<T extends firebase.firestore.DocumentData >(path: string): AngularFirestoreDocument<T>;
    doc<T extends firebase.firestore.DocumentData>(ref: DocumentReference): AngularFirestoreDocument<T>;
    /**
