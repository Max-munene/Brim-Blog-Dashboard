 ...
 */
export declare class AngularFirestoreCollection<T extends firebase.firestore.DocumentData = DocumentData> {
     ...
     */
    doc<T2 extends firebase.firestore.DocumentData = T>(path?: string): AngularFirestoreDocument<T2>;
}
