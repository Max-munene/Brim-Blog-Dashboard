 ...
 */
export declare class AngularFirestoreDocument<T extends firebase.firestore.DocumentData = DocumentData> {
     ...
     * function.
     */
    collection<R extends firebase.firestore.DocumentData = DocumentData>(path: string, queryFn?: QueryFn): AngularFirestoreCollection<R>;
    /**
